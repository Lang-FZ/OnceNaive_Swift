...
private let lang_key:String = "OnceNaiveLanguage"
public let language_changed:Notification.Name = Notification.Name.init("OnceNaiveLanguageChanged")
...
class LocalizationTool: NSObject {
    ...
    public class func saveCurrentLanguage(_ language:String = "") -> String {
        ...
        NotificationCenter.default.post(name: language_changed, object: nil)
